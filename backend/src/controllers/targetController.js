...
async function assignTarget(req, res) {
  try {
    ...
    const target = await Target.create({
      ...
      companyId,
      targetDuration,
      profilesSourcingTarget: (profilesSourcingTarget === '' || profilesSourcingTarget == null) ? null : profilesSourcingTarget,
      totalSubmissionTarget: (totalSubmissionTarget === '' || totalSubmissionTarget == null) ? null : totalSubmissionTarget,
      interviewTarget: (interviewTarget === '' || interviewTarget == null) ? null : interviewTarget,
      avgWeeklySubmissionsTarget: (avgWeeklySubmissionsTarget === '' || avgWeeklySubmissionsTarget == null) ? null : avgWeeklySubmissionsTarget,
