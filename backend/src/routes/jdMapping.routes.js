...
router.get('/api/assignments/', ctrl.listAssignments);
router.post('/api/assignments/create/', ctrl.createAssignment);
router.get('/api/assignments/:pk/', ctrl.assignmentDetail);
router.delete('/api/assignments/:pk/delete/', ctrl.deleteAssignment);
router.post('/api/submissions/create/', ctrl.createSubmission);
router.delete('/api/submissions/:pk/delete/', ctrl.deleteSubmission);
