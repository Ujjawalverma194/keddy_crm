...
const { uploadVendor, uploadClient, uploadResume, uploadTimesheet, uploadVendorInvoice } = require('../middleware/upload');
...
router.put('/api/vendors/:vendor_id/update/', uploadVendor.any(), vendors.update);
...
router.patch('/api/clients/:client_id/update/', uploadClient.any(), clients.update);
router.put('/api/clients/:client_id/update/', uploadClient.any(), clients.update);
...
// Candidates
router.post('/api/candidates/parse-resume/', uploadResume.single('resume'), candidates.parseResume);
router.post('/api/candidates/create/', uploadResume.single('resume'), candidates.create);
...
router.get('/api/candidates/:candidate_id/timesheets/', candidates.listTimesheets);
router.post('/api/candidates/:candidate_id/timesheets/', uploadTimesheet.single('file'), candidates.createTimesheet);
router.delete('/api/timesheets/:pk/delete/', candidates.deleteTimesheet);

router.get('/api/candidates/:candidate_id/vendor-invoices/', candidates.listVendorInvoices);
router.post('/api/candidates/:candidate_id/vendor-invoices/', uploadVendorInvoice.single('file'), candidates.createVendorInvoice);
router.delete('/api/vendor-invoices/:pk/delete/', candidates.deleteVendorInvoice);

router.get('/api/candidates/:candidate_id/client-invoices/', candidates.clientInvoices);
...
router.get('/dashboard/team/today-submissions/', dashboard.todayTeamSubmissions);
