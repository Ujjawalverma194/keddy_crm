...
function UpdateCandidate() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const vendorRes = await apiRequest("/employee-portal/api/comapany/vendors/pool/");
  ...
  const fetchSearchVendors = async (query) => {
    try {
      const res = await apiRequest(`/employee-portal/api/comapany/vendors/pool/?search=${query}`);
      setVendors(
        Array.isArray(res)
          ? res
