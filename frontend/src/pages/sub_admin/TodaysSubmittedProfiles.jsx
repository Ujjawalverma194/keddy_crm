...
function TodayVerifiedProfiles() {
      ...
      return (
        <React.Fragment key={c.id || i}>
          ...
          >
            ...
            <td style={styles.td}>
              {truncate(c.client_company_name || c.client_name || "N/A", 20)}
            </td>
            <td style={styles.td}>
  ...
  {c.resume ? (
    <div style={styles.resumeActions}>
      <button
        onClick={(e) =>
          handlePreviewResume(e, c.resume)
        }
    ...
    <span style={styles.noResumeBadge}>
      Not Uploaded
    </span>
  )}
</td>
      ...
      <div style={styles.header}>
        <div>
          <h2 style={styles.welcome}>
            Today's Submitted Profiles ({candidates.length})
          </h2>
          <p style={styles.subText}>
            Real-time overview of profiles submitted today.
          </p>
        </div>
      </div>
