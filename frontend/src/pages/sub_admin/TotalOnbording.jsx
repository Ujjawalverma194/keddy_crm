...
const [pdfPages, setPdfPages] = useState(null);
  ...
  const updateCandidateInCurrentList = (candidateId, updatedData) => {
    setCandidates((prev) =>
      prev.map((item) => {
        const itemCandidateId = getCandidateId(item);

        if (String(itemCandidateId) !== String(candidateId)) {
          return item;
        }
  ...
  const handleUpdateSubmit = async () => {
    ...
    try {
      ...
      updateCandidateInCurrentList(candidateId, editForm);
      ...
      return (
        <React.Fragment key={c.id}>
          ...
          >
            <td style={styles.td}>
              <div>
                To: <b>{truncate(c.submitted_to_name, 15) || "-"}</b>
              </div>
              <div>
                By:{" "}
                <b style={{ color: "#27AE60" }}>
                  {truncate(c.created_by_name, 15) || "-"}
                </b>
              </div>
            </td>
            <td style={styles.td}>
              ...
              >
                <button
                  onClick={(e) => {
                    ...
                    setSelectedCand(c);
                    setEditForm({
                      main_status: c.main_status || "ONBORD",
                      sub_status: c.sub_status || "NONE",
                      remark: c.remark || "",
                    });
  ...
  return (
    <SubAdminLayout>
      ...
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subText}>
            Profiles that have successfully moved to the onboarding stage.
          </p>
        </div>
      </div>
      ...
      <div style={styles.buttonBar}>
        <button
          onClick={() => navigate("/sub-admin/offboarded-profiles")}
          style={styles.offboardedBtn}
        >
      ...
      <div style={styles.filterBar}>
        <input
          placeholder="Search onboarded candidates..."
  ...
  >
    ...
    >
      <div style={styles.previewHeader}>
        <h3 style={{ margin: 0, color: "#25343F" }}>
          Resume Preview
        </h3>
