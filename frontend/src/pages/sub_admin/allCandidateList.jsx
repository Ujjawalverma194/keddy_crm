...
function CandidateList() {
  ...
  const getInitialFilters = () => {
    ...
    return {
      ...
      rate_value: params.get("rate_value") || "",
    };
  };
...
const handlePreviewPDF = async (e, resume) => {
  ...
  // JD filter uses exact word-level matching, not partial substring matching.
                ...
                >
                  ...
                  <div style={styles.categoryFilterGrid}>
                    ...
                    <div style={styles.categoryFilterGroupWide}>
                      ...
                      <textarea
                        placeholder="Paste full JD or type JD keywords. Matching profiles will be sorted by highest match percentage."
                      ...
                      <div style={styles.filterHelperText}>
                        Exact word matching with weighted profile fields. Tech-only match will not show 100% unless other relevant fields also match.
                      </div>
                    </div>
