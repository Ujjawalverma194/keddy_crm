...
//     // Step 2: Update API Call (PUT)
//     const handleSubmit = async (e) => {
//         e.preventDefault();
//         setUpdating(true);

//         const data = new FormData();
//         // Sirf wahi fields jo update karni hain
//         Object.keys(formData).forEach((key) => {
//             data.append(key, formData[key]);
//         });
        
//         if (benchListFile) {
//             data.append("bench_list", benchListFile);
//         }
...
//                     <div style={styles.inputGroup}>
//                         <label style={styles.label}>Website</label>
//                         <input type="text" name="company_website" value={formData.company_website} onChange={handleChange} style={styles.input} />
//                     </div>
//                     <div style={styles.inputGroup}>
//                         <label style={styles.label}>POC Name</label>
//                         <input type="text" name="poc1_name" value={formData.poc1_name} onChange={handleChange} style={styles.input} />
//                     </div>
//                     <div style={styles.inputGroup}>
//                         <label style={styles.label}>POC Number</label>
//                         <input type="text" name="poc1_number" value={formData.poc1_number} onChange={handleChange} style={styles.input} />
//                     </div>
//                     <div style={styles.inputGroup}>
//                         <label style={styles.label}>Onsite Location</label>
//                         <input type="text" name="onsite_location" value={formData.onsite_location} onChange={handleChange} style={styles.input} />
//                     </div>
//                     <div style={styles.inputGroup}>
//                         <label style={styles.checkboxLabel}>
//                             <input type="checkbox" name="provide_onsite" checked={formData.provide_onsite} onChange={handleChange} />
//                             Provide Onsite?
//                         </label>
//                     </div>
//                     <div style={styles.inputGroup}>
//                         <label style={styles.label}>Update Bench List (File)</label>
//                         <input type="file" onChange={(e) => setBenchListFile(e.target.files[0])} style={styles.input} />
//                     </div>
//                 </div>
...
// const styles = {
//     topBar: { display: "flex", alignItems: "center", gap: "20px", marginBottom: "25px" },
//     backBtn: { background: "none", border: "none", color: "#25343F", fontWeight: "700", cursor: "pointer" },
//     pageTitle: { fontSize: "24px", color: "#25343F", margin: 0, fontWeight: "800" },
//     formCard: { background: "#fff", padding: "30px", borderRadius: "20px", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" },
//     grid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" },
//     inputGroup: { display: "flex", flexDirection: "column", gap: "8px" },
//     label: { fontSize: "14px", fontWeight: "700", color: "#25343F" },
//     input: { padding: "12px", borderRadius: "10px", border: "1px solid #BFC9D1", outline: "none" },
//     checkboxLabel: { display: "flex", alignItems: "center", gap: "10px", fontWeight: "700", cursor: "pointer", marginTop: "30px" },
