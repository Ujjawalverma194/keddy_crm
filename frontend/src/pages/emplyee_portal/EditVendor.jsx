...
const [isSubmitting, setIsSubmitting] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        setTimeout(() => navigate('/employee/vendors'), 1500);
      } catch (error) {
        console.error("Vendor update error:", error);
        notify("Error updating vendor. Please check all fields.", "error");
    } finally {
        ...
        <div style={styles.hero}>
          <div style={styles.heroLeft}>
            <button type="button" onClick={() => navigate(-1)} style={styles.backBtn} title="Back">
              ...
              <div>
                <h2 style={styles.pageTitle}>Edit Vendor</h2>
                <p style={styles.pageSubtitle}>Update vendor details and POC information.</p>
              </div>
          </div>
